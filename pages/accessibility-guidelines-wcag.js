  ...
  return (
    <Layout>
      <PageContent>
        ...
        <Text>Level A: The most basic web accessibility features. </Text>
        <Text>Level AA: Deals with the most common barriers for disabled users. </Text>
        <Text>Level AAA: The highest (and most complex) level of web accessibility. </Text>
